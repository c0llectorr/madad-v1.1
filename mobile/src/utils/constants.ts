...
export const NEED_TYPES = ['Food', 'Water', 'Medical Evac', 'Shelter', 'Medicine', 'Gen. Evac'];
...
export const SEV_API: Record<string, string> = { Low: 'low', Medium: 'medium', High: 'high', Critical: 'critical' };

export const FLAG_TYPES = ['Elderly Present', 'Children Present', 'Pregnancy', 'Injury Reported', 'Water Rising Fast', 'Stranded / No Exit'];
