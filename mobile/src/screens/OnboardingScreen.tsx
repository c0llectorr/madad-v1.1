    ...
    <View style={s.container}>
      ...
      <View style={s.heroWrap}>
        <View style={s.medallion}>
          ...
          <View style={[s.mapBg]} />
          <View
            style={[s.road, { top: "30%", left: 0, right: 0, height: 10 }]}
          />
          <View
            style={[s.road, { top: "58%", left: 0, right: 0, height: 14 }]}
          />
          <View
            style={[s.road, { left: "28%", top: 0, bottom: 0, width: 10 }]}
          />
          <View
            style={[s.road, { left: "62%", top: 0, bottom: 0, width: 14 }]}
          />
          <View style={[s.river]} />
          <View
            style={[
              s.block,
              { top: "12%", left: "10%", width: 40, height: 26 },
            ]}
          />
          <View
            style={[
              s.block,
              { top: "16%", right: "12%", width: 52, height: 30 },
            ]}
          />
          <View
            style={[
              s.block,
              { bottom: "18%", left: "16%", width: 60, height: 34 },
            ]}
          />
          <View
            style={[
              s.block,
              { bottom: "12%", right: "10%", width: 44, height: 24 },
            ]}
          />
          <View
            style={[s.park, { top: "36%", left: "40%", width: 56, height: 40 }]}
          />
        </View>
      ...
      <Text style={[T.headlineLg, s.headline]}>
        Precision Relief,{"\n"}Real-Time Response.
      </Text>
      <Text style={[T.bodyLg, s.sub]}>
        Coordinating support centers, depots, and field teams for efficient
        flood response.
      </Text>
      ...
      >
        <Text style={[T.labelLg, { color: C.onPrimary, fontSize: 16 }]}>
          Get Started
        </Text>
